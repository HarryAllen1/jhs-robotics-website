...
<nav class="top-0 mb-4 px-6 text-lg sm:text-xl md:text-2xl text-black w-full border-b z-20">
  <div class="py-4 pr-4 flex justify-between items-center">
    ...
    <a class="mx-1 md:mx-2" href="https://discord.gg/FdFkZFJa3H" target="_blank">Discord Server</a>
    <a class="mx-1 md:mx-2" href="/donate">Donate</a>
  </div>
</nav>
